...
**Acknowledgments**<br> 
We sincerely thank providers of the TR dataset (https://doi.org/10.1111/2041-210x.12933) and developers of the LeWoS (https://doi.org/10.1111/2041-210X.13342), Laplacian contraction (https://doi.org/10.1109/SMI.2010.25, https://doi.org/10.1016/j.agrformet.2019.107874)<br>, L1-medial ( https://doi.org/10.1145/2461912.2461913)<br>, CloudCompare (www.cloudcompare.org)<br>, HELIOS ++ (https://www.sciencedirect.com/science/article/pii/S0034425721004922)<br>, and Starlab software (https://github.com/OpenGP/starlab)<br>. We also thank our colleague Zengxin Yun for helping us compile the HELIOS ++ software.
