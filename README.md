...
**In the folder 'script (in Python)', 'WoodSKE.py' is used to extract the skeleton of woody point clouds, while 'ANGLE-CALCULAT.py' is used to extract the inclination angles of single branches based on the woody point clouds and the WoodSKE-extracted skeletons.**<br>
